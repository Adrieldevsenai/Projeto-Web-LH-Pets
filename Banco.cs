    ...
    public class Banco
    {
        ...
        public string GetListaString() {
            ...
            string enviar = "<!DOCTYPE html>\n<html>\n<head>\n<meta charset='utf-8'/>\n" +
                            ...
                            "<style>table{border-spacing: 0; border-collapse: collapse;} th, td{border: 1px solidblack; padding: 0 10px;} tbody tr:nth-child(even){background: #ccc}";
                            "</head>\n<body>" +
